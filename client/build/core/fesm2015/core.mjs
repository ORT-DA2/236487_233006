...
class DialogService {
    ...
    openDialog(dialogType, payload = null) {
        ...
        this.dialogStateTracker$.next(Object.assign(Object.assign({}, this.dialogStateTracker$.value), { [dialogType]: true }));
    }
    closeDialog(dialogType) {
        this.payloadState$.next(null);
        this.dialogStateTracker$.next(Object.assign(Object.assign({}, this.dialogStateTracker$.value), { [dialogType]: false }));
    }
    get data() {
        var _a;
        return (_a = this.payloadState$.value) === null || _a === void 0 ? void 0 : _a.data;
    }
    get payload() {
